    ...
    <div>
      <div className="main-body ">
        <div className="nav-bar">
          ...
          <img src="https://cdn.freebiesupply.com/logos/large/2x/movie-city-logo-png-transparent.png" className='logo-img'/>
...
<Card />
  ...
  <div className='end-bar'>@Design_By_MathanStunnerz</div>
  </div>
)
}
function Card(){
  ...
  return (
    <div>
         ...
         <span className='rating material-symbols-outlined'>Star</span>
